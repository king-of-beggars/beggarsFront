...
function MainJourney({ twoWeeks }) {
  ...
  const { width: boxWidth, height: boxHeight } = getAssetSize(
    frameSize,
    screenWidth,
    mainJourneyBox
  );
  const { width: titleWidth, height: titleHeight } = getAssetSize(
    frameSize,
    screenWidth,
    mainJourneyTitle
  );
  const { width: rowWidth, height: rowHeight } = getAssetSize(
    frameSize,
    screenWidth,
    mainJourneyBoxRow
  );
  const { width: roundWidth, height: roundHeight } = getAssetSize(
    frameSize,
    screenWidth,
    mainJourneyRoundBox
  );
